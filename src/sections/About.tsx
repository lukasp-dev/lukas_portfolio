    ...
    return (
        <section className="c-space my-20" id="about">
            ...
            <div className="mt-20 grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div
                        className="grid-container flex flex-col items-center p-6 sm:p-8 bg-black rounded-lg shadow-md h-full justify-between">
                        <div
                            className="flex-grow grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 items-center justify-center">
